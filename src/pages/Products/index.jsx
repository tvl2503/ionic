...
// Sử dụng component  IonButton, IonIcon, IonItem, IonList, IonSelect, IonSelectOption của ionic
          ...
          {products.length > 0 &&
            products.map((item, index) => {
              return (
                <div
                  key={index}
                  style={{ maxWidth: "25%", paddingLeft: 7, paddingRight: 7 }}
                >

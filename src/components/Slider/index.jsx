  ...
  return (
    <div className='slider'>
        ...
        <div className="slider__control">
            <IonButton color = {"transparent"} className="slider__control__item" onClick={prevSlide}>
                <IonIcon icon = {chevronBackOutline} />
            </IonButton>
            <IonButton color = {"transparent"} className="slider__control__item" onClick={nextSlide}>

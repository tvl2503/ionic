...
// Sử dụng component  IonButton, IonGrid, IonIcon, IonImg, IonRow, IonText   của ionic
      ...
      <IonRow className="header__top">
            ...
            <div className="header__top__search__product">
              {products.map((item, index) => (
                <div
                  className="product"
                  key={index}
                  onClick={() => onClickProduct(`/product/${item._id}`)}
                >
                  <div className="img">
        ...
        <IonItemComponent className="header__top__user">
          {!user && (
            <>
              <Link to="/user/login">
                <IonText color={"light"}>Đăng nhập</IonText>
              </Link>
